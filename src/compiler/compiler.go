...
type Compiler struct {
	...
	symbolTable         *SymbolTable       // symbol table :O
}
...
func (c *Compiler) Compile(node ast.Node) error {
	...
	case *ast.HashLiteral:
		...
		// only to facilitate tests as Go doesn't guarantee key order on maps
...
// Check if last instruction (c.lastInstruction) is a OpPop
