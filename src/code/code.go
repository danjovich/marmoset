...
type Definition struct {
	// opcode name
	Name string
	// number of bytes each operand takes up
	OperandWidths []int
}
...
// creates bytecode instruction from opcode and operand lengths
...
// reads two bytes from instructions
func ReadUint16(ins Instructions) uint16 {
	return binary.BigEndian.Uint16(ins)
}

// reads one byte from instructions
