// recursive descent parser (there are other types - see Ball pp. 31-2)
package parser
...
func New(l *lexer.Lexer) *Parser {
	...
	// associate prefix tokens with parsing functions
	...
	// associate infix tokens with parsing functions
	...
	// indexing is treated as a prefix expression
...
// checks if next token is the expected and advance the parer if it is, generates error otherwise
...
const (
	// iota indicates the constants have incrementing numbers as values
	_ int = iota
	LOWEST
	EQUALS      // ==
	LESSGREATER // > or <
...
// Never advance tokens (too far) on parsing functions!
// identifiers
...
// block statements (series of statements)
...
// expression lists (like arguments of a function or arrays)
